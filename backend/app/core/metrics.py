...
vectorstore_upsert_completed = _LazyInstrument("vectorstore_upsert_completed")
vectorstore_upsert_failed = _LazyInstrument("vectorstore_upsert_failed")
...
vectorstore_delete_completed = _LazyInstrument("vectorstore_delete_completed")
vectorstore_delete_failed = _LazyInstrument("vectorstore_delete_failed")
vectorstore_delete_duration_seconds = _LazyInstrument(
    "vectorstore_delete_duration_seconds"
)
vectorstore_search_completed = _LazyInstrument("vectorstore_search_completed")
vectorstore_search_failed = _LazyInstrument("vectorstore_search_failed")
